...
HD_PWD='C:/Users/dievi/Documents/Vivado_projects/async_fifo/async_fifo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log async_synchronizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source async_synchronizer.tcl
