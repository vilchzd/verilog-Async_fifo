...
HD_PWD='C:/Users/dievi/Documents/Vivado_projects/async_fifo/async_fifo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log async_synchronizer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source async_synchronizer.tcl -notrace
